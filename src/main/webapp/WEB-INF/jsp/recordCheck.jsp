...
<body style="background-color: #fffeee;">
	...
	<p>
		<a href="/portfolio1/SalesRecordChangeServlet?action=done">追加</a><br>
		<a href="/portfolio1/SalesRecordChangeServlet">削除</a><br>
		<a href="/portfolio1/MainServlet">トップページへ戻る</a>
	</p>
